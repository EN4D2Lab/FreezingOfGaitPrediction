# -*- coding: utf-8 -*-
"""
Created on Wed Dec 24 12:47:04 2025
...
if area_df.empty:
    ...
    sc = joblib.load("scale_data.pkl")
    loaded_model = joblib.load("predict_output.pkl")
    ...
    selected_features = [
        'lh_inferiorparietal_area', 'lh_lingual_area',
               'lh_medialorbitofrontal_area', 'lh_middletemporal_area',
               'lh_parahippocampal_area', 'lh_parsopercularis_area',
               'lh_parsorbitalis_area', 'lh_pericalcarine_area',
               'lh_rostralanteriorcingulate_area', 'lh_superiorfrontal_area',
               'lh_supramarginal_area', 'lh_temporalpole_area', 'lh_insula_area',
               'rh_bankssts_area', 'rh_cuneus_area', 'rh_entorhinal_area',
               'rh_fusiform_area', 'rh_inferiortemporal_area', 'rh_lingual_area',
               'rh_middletemporal_area', 'rh_parsorbitalis_area',
               'rh_pericalcarine_area', 'rh_precuneus_area',
               'rh_superiortemporal_area', 'rh_supramarginal_area',
               'rh_temporalpole_area', 'rh_transversetemporal_area'
    ]
